        ...
        <div class="ss-contacts__map-info">
          <div class="ss-contacts__map-block">
            ...
            <p class="ss-contacts__map-text">
              <img src="../../assets/img/ss-contacts/marker.svg" alt="" />
              Новгородская область, город Боровичи, улица Ленинградская 25, офис
              2
            </p>
          </div>
          <div class="ss-contacts__map-block">
            <p class="ss-contacts__map-addr-header">Телефоны:</p>
            <p class="ss-contacts__map-text">
              <img src="../../assets/img/ss-contacts/phone.svg" alt="" />
              Менеджер <a href="tel:+78888888888">+7 888 888 88 88</a>
            </p>
            <p class="ss-contacts__map-text">
              <img src="../../assets/img/ss-contacts/phone.svg" alt="" />
              Справка <a href="tel:+78888888888">+7 888 888 88 88</a>
            </p>
          </div>
          <div class="ss-contacts__map-block">
            <p class="ss-contacts__map-addr-header">Сайт:</p>
            <p class="ss-contacts__map-text">
              <img src="../../assets/img/ss-contacts/earth.svg" alt="" />
          ...
          <div class="ss-contacts__map-block">
            ...
            <p class="ss-contacts__map-text">
              <img src="../../assets/img/ss-contacts/mail.svg" alt="" />
              <a href="mailto:qwert@mail.com">qwert@mail.com</a>
            </p>
          </div>
          <p class="ss-contacts__map-text">
            Строительная компания, строительство дачных домов и коттеджей,
...
<script src="./ss-contacts.js"></script>
